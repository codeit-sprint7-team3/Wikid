...
const QuizModal: React.FC<QuizModalProps> = ({ isOpen, onClose, question, correctAnswer, onSubmit }) => {
  ...
  return (
    <div className={style.modalContainer}>
      <div className={style.modalContent}>
        ...
        />
        <button onClick={handleSubmit} className={style.submitButton}>확인</button>

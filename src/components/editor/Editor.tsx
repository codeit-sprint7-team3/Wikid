...
const addCustomButton = (editor: any, iconName: string, icon: string, tooltipText: string, command: string) => {
...
const TinyMceEditor = forwardRef<any, Props>(({ initialValue, editorRef }): JSX.Element => {
  const tinymcePlugins = ["link", "lists", "autoresize", "media", "quickbars", "image", "noneditable"];
    ...
    <Editor
      ...
      init={{
        ...
        setup: (editor) => {
          ...
          addCustomButton(editor, "customItalic", italicIcon, "Italic", "Italic");
          addCustomButton(editor, "customUnderline", underlineIcon, "Underline", "Underline");
          addCustomButton(editor, "customBullist", bullistIcon, "Bullet list", "InsertUnorderedList");
          addCustomButton(editor, "customNumlist", numlistIcon, "Numbered list", "InsertOrderedList");
          addCustomButton(editor, "customAlignleft", alignleftIcon, "Align left", "JustifyLeft");
          addCustomButton(editor, "customImage", imageIcon, "Insert Image", "mceImage");
          addCustomButton(editor, "customVideo", videoIcon, "Media", "mceMedia");
